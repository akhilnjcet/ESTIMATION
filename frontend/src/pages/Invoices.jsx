      ...
      <div className="invoice-container">
        <div className="invoice-header">
          ...
          <div style={{ textAlign: 'right' }}>
            <h1 style={{ margin: 0, color: '#111', fontSize: '32px', fontWeight: '900', letterSpacing: '-1px' }}>INVOICE</h1>
        ...
        <div className="total-section">
          ...
          <div className="invoice-footer">
            <div style={{ maxWidth: '350px' }}>
              <h4 style={{ fontSize: '12px', fontWeight: '700', marginBottom: '8px' }}>Notes & Instructions:</h4>
              <p style={{ fontSize: '10px', color: '#888', lineHeight: '1.5', margin: 0 }}>
                1. Goods once sold will not be taken back.<br/>
                2. Interest @18% will be charged if not paid on time.<br/>
