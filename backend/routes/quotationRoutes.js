...
router.post('/', protect, async (req, res) => {
  try {
    ...
    const { customer, items, subTotal, taxAmount, discount, totalAmount, notes, terms, date, showTerms, showTax, showItemPrices, showPaymentTerms, showSignature, showFooter, footerText, theme, quotationNumber } = req.body;
    ...
    const quotation = new Quotation({
      ...
      showItemPrices: showItemPrices !== undefined ? showItemPrices : true,
...
router.put('/:id', protect, async (req, res) => {
  try {
    ...
    const { customer, items, subTotal, taxAmount, discount, totalAmount, notes, terms, date, showTerms, showTax, showItemPrices, showPaymentTerms, showSignature, showFooter, footerText, theme, status, quotationNumber } = req.body;
